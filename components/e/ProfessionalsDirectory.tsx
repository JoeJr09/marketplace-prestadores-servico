...
export function ProfessionalsDirectory({
  ...
  useEffect(() => {
    ...
    async function loadFavorites() {
      ...
      try {
        ...
        const data =
          (await response.json()) as FavoritesResponse;
  ...
  async function toggleFavorite(
    ...
    const isFavorite =
      favorites.includes(professionalId);
  ...
  return (
    <>
      ...
      {!(
        ...
        <section className="rounded-lg bg-white/70 p-8 text-text-muted">
          {showFavoritesOnly
            ? "Voce ainda nao favoritou nenhum prestador."
                ...
                >
                  ...
                  <div className="space-y-5 p-5">
                    ...
                    <p className="min-h-16 text-sm leading-6 text-text-muted">
                      {professional.bio ||
                        "Prestador cadastrado na plataforma, pronto para configurar servicos e receber solicitacoes."}
                    </p>
