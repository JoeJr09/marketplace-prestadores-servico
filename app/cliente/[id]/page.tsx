...
const clientSelect =
  "id, full_name, email, phone, avatar_url, bio, created_at";
        ...
        <section className="relative overflow-hidden px-6 py-10 sm:px-10 lg:px-14 lg:py-14">
          ...
          <div className="relative mx-auto grid max-w-7xl gap-8 lg:grid-cols-[minmax(0,1.5fr)_380px] lg:items-start">
            <div className="rounded-[2rem] border border-white/70 bg-white/55 p-8 shadow-[0_24px_80px_rgba(4,22,39,0.08)] backdrop-blur sm:p-10 lg:p-12">
              ...
              <p className="mt-5 max-w-2xl break-words whitespace-pre-wrap text-lg leading-9 text-text-muted sm:text-xl">
                {client.bio ??
                  "Cliente cadastrado no marketplace com contato centralizado para acompanhamento de serviços, solicitações e histórico de relacionamento."}
              </p>
            ...
            <aside className="space-y-7">
              ...
              <div className="rounded-[2rem] bg-brand-steel-mid p-8 text-white shadow-[0_24px_80px_rgba(4,22,39,0.18)]">
                ...
                <p className="mt-3 text-base text-white/70">
                  Dados principais exibidos no frontend.
                </p>
              ...
              <div className="mt-8 grid gap-5 sm:grid-cols-2">
                ...
                {client.bio ? (
                  <div className="rounded-[1.5rem] border border-border bg-surface-plain p-5 sm:col-span-2">
                    ...
                    <p className="mt-3 max-w-full break-words whitespace-pre-wrap text-lg leading-8 text-text-muted [overflow-wrap:anywhere]">
                      {client.bio}
                    </p>
                  </div>
                ) : isOwner ? (
                  <div className="rounded-[1.5rem] border border-dashed border-border bg-surface-plain p-5 sm:col-span-2">
                    ...
                    <p className="mt-3 text-base italic text-text-subtle">
                      Você ainda não adicionou uma bio. Edite seu perfil para
