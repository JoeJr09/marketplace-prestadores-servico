...
function getRedirectPath(
  ...
  if (requestedRedirect && requestedRedirect.startsWith("/prestador")) {
              ...
              <div className="relative z-10 space-y-8">
                ...
                <div className="max-w-xl space-y-6">
                  <h1 className="text-5xl font-black leading-[0.98] tracking-[-0.05em] text-white xl:text-6xl">
                    Encontre o profissional certo para o serviço que você precisa.
                  </h1>
                  <p className="max-w-lg text-xl leading-9 text-white/64">
                    Acesse uma rede selecionada de prestadores para manutenção,
                    obras, atendimento técnico e demandas do dia a dia.
                  </p>
                </div>
              </div>
              <div className="relative z-10 grid grid-cols-2 gap-8 text-white">
                <div className="space-y-2">
                  <p className="text-5xl font-black tracking-[-0.06em]">12k+</p>
                  <p className="text-xs uppercase tracking-[0.3em] text-white/48">
                    Especialistas cadastrados
                  </p>
                </div>
                <div className="space-y-2">
                  <p className="text-5xl font-black tracking-[-0.06em]">4.9/5</p>
                  <p className="text-xs uppercase tracking-[0.3em] text-white/48">
                    Avaliação média
                  </p>
                </div>
              ...
              <div className="mx-auto w-full max-w-md">
                <div className="mb-10 space-y-3">
                  ...
                  <p className="text-lg text-text-muted">
                    Entre para acompanhar pedidos, perfis e contatos.
                  </p>
                </div>
