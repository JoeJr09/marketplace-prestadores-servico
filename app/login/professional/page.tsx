            ...
            <div className="relative z-10 space-y-8">
              ...
              <div className="max-w-xl space-y-6">
                <h1 className="text-5xl font-black leading-[0.98] tracking-[-0.04em] text-white xl:text-6xl">
                  Manage your services with precision.
                </h1>
                <p className="max-w-lg text-xl leading-9 text-white/64">
                  Access requests, update your profile, and keep your service
                  pipeline moving.
                </p>
              </div>
            </div>
            ...
            <div className="mx-auto w-full max-w-md">
              <div className="mb-10 space-y-3">
                ...
                <p className="text-lg text-text-muted">
                  Log in to manage your provider account.
                </p>
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-7">
                ...
                >
                  {isSubmitting ? "Logging in..." : "Log In as Professional"}
                </Button>
              </form>
