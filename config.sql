...
CREATE TABLE public.calendar (
  ...
  CONSTRAINT calendar_id_professional_fkey FOREIGN KEY (id_professional) REFERENCES public.professionals(id),
  CONSTRAINT calendar_id_cliente_fkey FOREIGN KEY (id_cliente) REFERENCES public.profiles(id),
  CONSTRAINT calendar_id_service_fkey FOREIGN KEY (id_service) REFERENCES public.services(id)
);
CREATE TABLE public.favorites (
  ...
  CONSTRAINT favorites_professional_id_fkey FOREIGN KEY (professional_id) REFERENCES public.professionals(id),
  CONSTRAINT favorites_cliente_id_fkey FOREIGN KEY (cliente_id) REFERENCES public.profiles(id)
);